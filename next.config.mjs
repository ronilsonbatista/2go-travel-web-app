...
const nextConfig = {
  async rewrites() {
    return [
      // English rewrites
      { source: '/en/destinations/:slug', destination: '/destinos/:slug?locale=en' },
      ...
      // Spanish rewrites
      { source: '/es/destinos/:slug', destination: '/destinos/:slug?locale=es' },
      ...
      // Portuguese rewrites
      { source: '/pt/destinos/:slug', destination: '/destinos/:slug?locale=pt' },
